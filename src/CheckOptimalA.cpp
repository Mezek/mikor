...
int main(int argc, char** argv)
{
	...
	vector<vector<int>> Wx8 {{8, 829, 32, 32},
		...
		{8, 2000003, 191437, 832685},
		{8, 5000011, 492261, 1777579}
	};
	...
	vector<vector<int>> W {{10, 5003, 431, 592},
		{10, 6007, 1262, 1262},
		{10, 8191, 1751, 1751},
		{10, 10007, 564, 1554},
		{10, 13001, 1415, 3466},
	...
	vector<vector<int>> Wx12 {{12, 20011, 2191, 9832},
		...
		{12, 200003, 24573, 80442},
		{12, 500009, 61365, 70666},
		{12, 1000003, 107377, 337644},
		{12, 2000003, 191389, 188931},
		{12, 5000011, 613507, 2100351}
	};

	vector<vector<int>> Wx13 {{13, 50021, 5407, 22854},
		{13, 75011, 8061, 28319},
		{13, 100003, 10761, 37813},
		{13, 200003, 24573, 98505},
		{13, 500009, 61371, 146033},
		{13, 1000003, 107375, 7110},
		{13, 2000003, 191433, 724650},
		{13, 5000011, 478471, 1475405}
	};

	vector<vector<int>> Wx14 {{14, 50021, 5407, 2711},
		{14, 75011, 8099, 34855},
		{14, 100003, 10143, 4329},
		{14, 200003, 19363, 64600},
		{14, 500009, 61371, 173675},
		{14, 1000003, 106245, 343964},
		{14, 2000003, 191433, 785082},
		{14, 5000011, 478471, 529347}
	};

	vector<vector<int>> Wx15 {{15, 50021, 5417, 14360},
		{15, 75011, 8061, 6348},
		{15, 100003, 10171, 11971},
		{15, 200003, 20015, 8712},
		{15, 500009, 61371, 193732},
		{15, 1000003, 106265, 38756},
		{15, 2000003, 191405, 667614},
		{15, 5000011, 478471, 1901327}
	};

	vector<vector<int>> Wx16 {{16, 200003, 25445},
		{16, 500009, 61373, 10055},
		{16, 1000003, 106257, 144679},
		{16, 2000003, 191405, 896847},
		{16, 5000011, 492613, 1663923}
	};

	vector<vector<int>> Wx17 {{17, 200003, 37201},
		{17, 500009, 61353, 40738},
		{17, 1000003, 106245, 143952},
		{17, 2000003, 191421, 366251},
		{17, 5000011, 492613, 127771}
	};

	vector<vector<int>> Wx18 {{18, 200003, 60437},
		{18, 500009, 61353, 174372},
		{18, 1000003, 106257, 58280},
		{18, 2000003, 191421, 826108},
		{18, 5000011, 478471, 1621377}
	};

	vector<vector<int>> Wx19 {{19, 500009, 61353, 223350},
		{19, 1000003, 106245, 452812},
		{19, 2000003, 191421, 698444},
		{19, 5000011, 478471, 1903132}
	};
